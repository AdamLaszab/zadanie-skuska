...
interface DeletePagesForm {
    file: File | null;
    pages: string; // Strany na vymazanie, napr. "1,3-5"
    output_name: string;
    [key: string]: any; // Pre FormDataType
}

const form = useForm<DeletePagesForm>({
    file: null,
    pages: '',
    output_name: '',
});
...
function submit() {
    ...
    form.post(route('pdf.tool.delete_pages.process'), {
        onSuccess: () => {
...
<template>
    <DashboardLayout>
        <Head title="Delete Pages from PDF" />
            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <h2 class="mb-6 text-center text-2xl font-semibold">Delete Pages from PDF</h2>
                        ...
                        <div v-if="globalErrors?.process_error" class="mb-4 rounded border border-red-400 bg-red-100 p-4 text-red-700">
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    class="mt-1 block w-full rounded-md border-gray-300 bg-white text-gray-900 shadow-sm focus:border-sky-500 focus:ring-sky-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                                    placeholder="document-with-deleted-pages"
                                />
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {{ form.processing ? 'Processing...' : 'Delete Pages' }}
                                </button>
                            </div>
                        </form>
                    </div>

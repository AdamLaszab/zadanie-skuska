...
const form = useForm<ReverseForm>({
  file: null,
  output_name: '',
});
...
function submit() {
  ...
  form.post(route('pdf.tool.reverse_pages.process'), {
    onSuccess: () => {
      form.reset();
      ...
      <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900 dark:text-gray-100">
            <h2 class="text-2xl font-semibold mb-6 text-center">Reverse Order of Pages in PDF</h2>
            ...
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div>
                <button type="submit" :disabled="form.processing || !form.file" class="w-full submit-button-style">
                  {{ form.processing ? 'Processing...' : 'Reverse Pages' }}
                </button>
              </div>
            </form>
          </div>
...
.dark .file-input-style::-webkit-file-upload-button:hover {
